    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                <form method="POST" action="{{ route('admin.banner.store') }}" id="file-upload-form" class="uploader"
                    ...
                    <div>
                        ...
                        <input id="crud-form-1" name="title" type="text" class="form-control w-full" placeholder="Collection ...">
                    </div>
