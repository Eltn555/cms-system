                 ...
                 <div class="row">
                     <div class="col-12">
                         <div class="single-input-item">
                             ...
                             <div class="position-relative">
                                 <input name="name" type="text" id="first-name" wire:model="name" placeholder="Ваш имя"/>
                     ...
                     <div class="col-12">
                         <div class="single-input-item">
                             ...
                             <div class="position-relative">
                                 <input name="phone" wire:model="phone" type="tel" id="display-name" placeholder="+998 555 005 444"/>
                                 <div class="position-absolute icon-input">
                                     <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                          xmlns="http://www.w3.org/2000/svg">
                                         <path
