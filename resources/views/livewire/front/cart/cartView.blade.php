                            ...
                            <div class="cart-title w-100 px-3">
                                ...
                                <div class="product-details-action-wrap font-kyiv">
                                    <div class="product-details-price py-2 font-kyiv">
                                        <span class="p-1 fs-5 {{($item->discount_price == "") ? 'd-none' : 'new-price'}}">{{$item->discount_price}}  {{$item->discount_price > 999 ? 'сум' : '$'}}</span>
                                        <span class="p-1 fs-5 {{($item->discount_price == "") ? 'new-price' : 'old-price'}}">{{$item->price}} {{$item->price > 999 ? 'сум' : '$'}}</span>
                                    </div>
                                </div>
