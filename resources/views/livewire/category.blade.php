                                                ...
                                                <div class="product-wrap mb-35 aos-init aos-animate" data-aos="fade-up"
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <div class="product-price">
                                                            <span class="{{($product->discount_price != null) ? 'old-price' : ''}}">{{$product->price}}</span>
                                ...
                                <div class="sidebar-list-style">
                                    <ul>
                                        @foreach($categories as $category)
                                            <li wire:click="setCategory('{{$category->slug}}')"><a id="select-category-{{ $category->id }}">{{ $category->title }}<span>{{ $category->products->count() }}</span></a></li>
                                        @endforeach
                                    </ul>
                                </div>
