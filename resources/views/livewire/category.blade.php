...
<div class="breadcrumb-area bg-gray-4 breadcrumb-padding-1"
    ...
    <div class="container">
        <div class="breadcrumb-content text-center">
            ...
            <img src="{{asset(($icon != null) ? 'storage/'.$icon->image : '')}}" alt="">
        </div>
    </div>
        ...
        <div class="row flex-row-reverse">
                    ...
                    <div class="shop-topbar-right">
                        <div class="shop-sorting-area">
                            ...
                            <div class="nice-select nice-select-style-1" tabindex="0"><span class="current">Default Sorting</span>
                                <ul class="list">
                                    <li data-value="Default Sorting" class="option selected">Default Sorting
                                    </li>
                                    <li data-value="Sort by popularity" class="option">Sort by popularity</li>
                                    <li data-value="Sort by average rating" class="option">Sort by average
                                        rating
                                    </li>
                        ...
                        <div class="shop-view-mode nav" role="tablist">
                            <a class="active" href="#shop-1" data-bs-toggle="tab" aria-selected="true"
                               role="tab"><i
                    ...
                    <div class="tab-content jump">
                        <div id="shop-1" class="tab-pane active" role="tabpanel">
                            ...
                            <div id="product-list" class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product-wrap mb-35 aos-init" data-aos="fade-up"
                                         data-aos-delay="600">
                                        <div class="product-img img-zoom mb-25">
                                            <a href="product-details.html">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-5">
                                        <div class="product-list-img">
                                            <a href="product-details.html">
                                                <img src="assets/images/product/product-5.png"
                                                     alt="Product Style">
                                            </a>
                            ...
                            <div class="shop-list-wrap mb-30">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-5">
                                        <div class="product-list-img">
                                            <a href="product-details.html">
                                                <img src="assets/images/product/product-7.png"
                                                     alt="Product Style">
                                            </a>
                                            <div class="product-list-quickview">
                                                <button class="product-action-btn-2" title="Quick View"
                            ...
                            <div class="shop-list-wrap mb-30">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-5">
                                        <div class="product-list-img">
                                            <a href="product-details.html">
                                                <img src="assets/images/product/product-8.png"
                                                     alt="Product Style">
                                            </a>
                                            <div class="product-list-badge badge-right badge-pink">
                                                <span>-10%</span>
            ...
            <div class="col-lg-3">
                <div class="sidebar-wrapper">
                    <div class="sidebar-widget mb-40 aos-init aos-animate" data-aos="fade-up"
                         data-aos-delay="200">
                        ...
                        <div class="sidebar-list-style">
                            <ul>
                                @foreach($categories as $category)
                                    <li><a onclick="changeTitle({{$category->id}})"
