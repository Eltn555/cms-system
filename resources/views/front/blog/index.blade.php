    ...
    <div class="breadcrumb-area bg-gray-4 breadcrumb-padding-1">
        <div class="container">
            <div class="breadcrumb-content text-center">
                <h2 data-aos="fade-up" data-aos-delay="200" class="aos-init aos-animate">Blog</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrap mb-50 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrap mb-50 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                        <div class="blog-img-date-wrap mb-25">
                            <div class="blog-img">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrap mb-50 aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                        <div class="blog-img-date-wrap mb-25">
                            <div class="blog-img">
