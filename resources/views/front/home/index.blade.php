        ...
        <div class="new-categories pb-95 mt-4">
            <div class="container">
                <div class="pt-3 mb-20 font-cormorant position-relative row" data-aos="fade-up" data-aos-delay="50">
                    ...
                    <div class="col-6 justify-content-end align-items-end d-flex">
                        <div class="single-product-cart btn-hover ps-1 text-end">
                            <a href="#" class="p-2 ps-4 pe-4 text-dark bg-light border border-1 font-kyiv">Посетить в
                                магазин</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-around">
                    <div
                        class="col-xl-3 col-lg-4 col-md-12 col-sm-12 order-lg-0 order-md-1 order-sm-1 col-12 big-banner">
                    ...
                    <div class="col-lg-4 col-md-12 text-center px-3 py-0" data-aos="fade-up" data-aos-delay="50">
                        <div class="w-100 d-flex justify-content-center fw-bold font-kyiv mb-3">
                            <svg width="30" height="29" viewBox="0 0 25 24" fill="none"
                                ...
                                <path
                                    d="M19.7 11.1L19.7 10.2C19.7 6.80589 19.7 5.10883 18.5836 4.05442C17.4671 3 15.6702 3 12.0765 3L11.1235 3C7.52976 3 5.73288 3 4.61644 4.05442C3.5 5.10883 3.5 6.80589 3.5 10.2L3.5 13.8C3.5 17.1941 3.5 18.8912 4.61644 19.9456C5.73288 21 7.52976 21 11.1235 21H11.6"
                                    stroke="#F8B301" stroke-width="1.5" stroke-linecap="round"/>
                    ...
                    <div class="col-lg-4 col-md-12 text-center pt-md-4 pt-lg-0 px-3 py-0" data-aos="fade-up"
                        ...
                        <div class="w-100 d-flex justify-content-center fw-bold font-kyiv mb-3">
                            <svg width="30" height="29" viewBox="0 0 25 24" fill="none"
                                ...
                                <path
                                    d="M5.5 17.9724C4.40328 17.9178 3.7191 17.7546 3.23223 17.2678C2.74536 16.7809 2.58222 16.0967 2.52755 15M9.5 18H15.5M19.5 17.9724C20.5967 17.9178 21.2809 17.7546 21.7678 17.2678C22.5 16.5355 22.5 15.357 22.5 13V11H17.8C17.0555 11 16.6832 11 16.382 10.9021C15.7731 10.7043 15.2957 10.2269 15.0979 9.61803C15 9.31677 15 8.94451 15 8.2C15 7.08323 15 6.52485 14.8532 6.07295C14.5564 5.15964 13.8404 4.44358 12.9271 4.14683C12.4752 4 11.9168 4 10.8 4H2.5"
                                    stroke="#F8B301" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M2.5 8H8.5" stroke="#F8B301" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M2.5 11H6.5" stroke="#F8B301" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path
                    ...
                    <div class="col-lg-4 col-md-12 text-center pt-md-4 pt-lg-0 px-3 py-0 border-0" data-aos="fade-up"
                        ...
                        <div class="w-100 d-flex justify-content-center fw-bold font-kyiv mb-3">
                            <svg width="30" height="29" viewBox="0 0 25 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M6.75874 15.3167C6.39456 14.6299 6.0845 14 5 14C3.9155 14 3.60544 14.6299 3.24126 15.3167C2.90259 15.9554 2.1151 16.9661 2.72461 17.6457C3.04234 18 3.69489 18 5 18C6.30511 18 6.95766 18 7.27539 17.6457C7.8849 16.9661 7.09741 15.9554 6.75874 15.3167Z"
                                    stroke="#F8B301" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M14.2587 18.3167C13.8946 17.6299 13.5845 17 12.5 17C11.4155 17 11.1054 17.6299 10.7413 18.3167C10.4026 18.9554 9.6151 19.9661 10.2246 20.6457C10.5423 21 11.1949 21 12.5 21C13.8051 21 14.4577 21 14.7754 20.6457C15.3849 19.9661 14.5974 18.9554 14.2587 18.3167Z"
                                    stroke="#F8B301" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path
                                    d="M21.7587 15.3167C21.3945 14.6299 21.0845 14 20 14C18.9155 14 18.6054 14.6299 18.2413 15.3167C17.9026 15.9554 17.1151 16.9661 17.7246 17.6457C18.0423 18 18.6949 18 20 18C21.3051 18 21.9577 18 22.2754 17.6457C22.8849 16.9661 22.0974 15.9554 21.7587 15.3167Z"
                                    stroke="#F8B301" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M9.5 3H15.5" stroke="#F8B301" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M12.5 3L12.5 17" stroke="#F8B301" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path
                                    d="M5 14V11.75C5 9.67893 6.67893 8 8.75 8C10.8211 8 12.5 9.67893 12.5 11.75C12.5 9.67893 14.1789 8 16.25 8C18.3211 8 20 9.67893 20 11.75V14"
                                    stroke="#F8B301" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
